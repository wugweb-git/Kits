      ...
      case 'docs':
        return [
          ...
          { id: 'theming', label: 'Theming', icon: Palette },
          {
            ...
            icon: Layers,
            items: [
              { id: 'token-architecture', label: 'Architecture', icon: Layers, isNew: true },
              { id: 'system-layers', label: 'System Layers', icon: GitBranch, isNew: true },
              { id: 'token-mapping', label: 'Token → Output Map', icon: FileCode, isNew: true },
              { id: 'token-export', label: 'JSON Export', icon: Package, isNew: true },
              { id: 'mcp-connector', label: 'MCP Connector', icon: Zap, isNew: true },
            ],
          },
          {
            id: 'design-tokens',
            ...
            items: [
              ...
              { id: 'typography', label: 'Typography', icon: Type, isNew: true },
              { id: 'spacing', label: 'Spacing', icon: Maximize },
              { id: 'radius', label: 'Border Radius', icon: Circle },
              { id: 'breakpoints', label: 'Breakpoints & Fluid Type', icon: Grid3x3, isNew: true },
