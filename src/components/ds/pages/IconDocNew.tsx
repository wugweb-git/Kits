...
export function IconDocNew() {
  ...
  const selectedIconData = completeIconLibrary.find(icon => icon.name === selectedIcon);
  const IconComponent = selectedIconData?.component || ArrowRightIcon;

  const reactCode = `import { ${IconComponent.name} } from './components/wugweb/CompleteIconLibrary';
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Complete icon library extracted from Figma. {completeIconLibrary.length} icons organized by category with consistent sizing and color tokens.
            </p>
          </div>
          ...
          <div style={{
            ...
            {completeIconLibrary.length} Figma Icons
          </div>
        </div>
      </header>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <AnatomyItem
                label="Icon Frame"
                description="Consistent sizing (16, 20, 24, 32px) following 8-point grid"
                token="8px grid"
              />
              <AnatomyItem
                label="Vector Path"
                description="SVG paths extracted directly from Figma components"
                token="Figma Component"
              />
              <AnatomyItem
                label="Color Token"
                description="All icons use CSS variables for theming"
                token="var(--foreground)"
              />
              <AnatomyItem
                label="Stroke Width"
                description="1.33px or 2px stroke for outline icons"
                token="1.33 | 2px"
              />
            </div>
          </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                fontFamily: 'Inter Tight, sans-serif',
                fontWeight: 'var(--font-weight-medium)',
                background: !selectedCategory ? 'var(--accent)' : 'var(--surface-700)',
                color: !selectedCategory ? 'var(--accent-foreground)' : 'var(--foreground)',
                border: '1px solid',
            ...
            >
              All ({completeIconLibrary.length})
            </button>
            {categories.map((category) => {
              const count = getIconsByCategory(category).length;
              return (
                <button
                  key={category}
                  onClick={() => {
                  ...
                  style={{
                    ...
                    fontFamily: 'Inter Tight, sans-serif',
                    fontWeight: 'var(--font-weight-medium)',
                    background: selectedCategory === category ? 'var(--accent)' : 'var(--surface-700)',
        ...
        <div style={{
          ...
          {filteredIcons.length === 0 && (
            <div style={{
              ...
              <AlertCircle size={48} style={{ margin: '0 auto var(--spacing-3)' }} />
              <p style={{ fontSize: 'var(--text-base)', marginBottom: 'var(--spacing-2)' }}>
