import svgPaths from "./svg-92abkpk2dc";
...
export default function ButtonDark() {
  return (
    <div className="bg-[#1a1a1a] content-stretch flex gap-[8px] items-center justify-center p-[20px] relative rounded-[12px] size-full" data-name="Button (Dark)">
